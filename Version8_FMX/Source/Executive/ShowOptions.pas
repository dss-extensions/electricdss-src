...
//        ParamPointer := 13;  {voltages}
   ...
   {Check commands requiring a solution and abort if no solution or circuit}
    ...
    case ParamPointer of
            ...
            begin
                ...
                begin
                    ...
                    if pMon <> NIL then
                        ...
                        DoSimpleMsg('Monitor "' + param + '" not found.' + CRLF + parser[ActiveActor].CmdString, 248);
                end;
            end
            else
                DoSimpleMsg('Monitor Name Not Specified.' + CRLF + parser[ActiveActor].CmdString, 249);
        end;
        11:
            ShowControlPanel;
        12:
        ...
        18:
            ShowEventLog(GetOutputDirectory + CircuitName_[ActiveActor] + 'EventLog.Txt');// ShowMessageForm(EventStrings);
        19:
