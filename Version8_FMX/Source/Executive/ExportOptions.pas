...
begin
    ...
    ExportHelp[20] := '(Default file = CIM17x.XML) (IEC 61968-13, CIM v17 extended, CDPSM Combined (unbalanced load flow) profile)' + CRLF + ' [Substation=subname SubGeographicRegion=subgeoname GeographicRegion=geoname File=filename]';
...
begin
    ...
    case ParamPointer of
        ...
        begin {user-supplied substation and regions}
            ...
            begin
                ...
                if CompareTextShortest(ParamName, 'f') = 0 then
                    FileName := Parm2;
                ParamName := LowerCase(parser[ActiveActor].nextParam);
                Parm2 := Parser[ActiveActor].strValue;
            end;
   ...
   {Assign default file name if alternate not specified}
    ...
    case ParamPointer of
        ...
        20:
            ExportCDPSM(Filename, Substation, SubGeographicRegion, GeographicRegion, Combined);
        21:
