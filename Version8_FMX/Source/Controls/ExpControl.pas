    ...
    begin
        ...
        begin
            ...
            case ParamPointer of
                ...
                3:
                    if Parser[ActorID].DblValue > 0 then
                        FSlope := Parser[ActorID].DblValue;
                4:
                    if Parser[ActorID].DblValue >= 0 then
                        FVregTau := Parser[ActorID].DblValue; // zero means fixed Vreg
                5:
                    FQbias := Parser[ActorID].DblValue;
                6:
                    if Parser[ActorID].DblValue > 0 then
                        FVregMin := Parser[ActorID].DblValue;
                7:
                    if Parser[ActorID].DblValue > 0 then
                        FVregMax := Parser[ActorID].DblValue;
                8:
                    if Parser[ActorID].DblValue >= 0 then
                        FQmaxLead := Parser[ActorID].DblValue;
                9:
                    if Parser[ActorID].DblValue >= 0 then
                        FQmaxLag := Parser[ActorID].DblValue;
                10:
