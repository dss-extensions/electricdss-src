    ...
    begin
        ...
        begin
            ...
            case ParamPointer of
                ...
                3:
                    VRef := Parser[ActorID].DblValue; // kv Output reference
                4:
                    pf := Parser[ActorID].DblValue; // power factor
                5:
                    Freq := Parser[ActorID].DblValue; // Freq
                6:
                begin
                ...
                7:
                    Xs := Parser[ActorID].DblValue; // Xs
                8:
                    Tol1 := Parser[ActorID].DblValue; // Tolerance Ctrl 2
                9:
                    ModeUPFC := Parser[ActorID].IntValue;
                10:
                    VpqMax := Parser[ActorID].DblValue;
                propLossCurve:
                    LossCurve := Param;
                12:
                    VHLimit := Parser[ActorID].DblValue;
                13:
                    VLLimit := Parser[ActorID].DblValue;
                14:
                    CLimit := Parser[ActorID].DblValue;
                15:
            ...
            case ParamPointer of
                propLossCurve:
                    UPFCLossCurveObj := XYCurveClass[ActorID].Find(LossCurve);
            end;
