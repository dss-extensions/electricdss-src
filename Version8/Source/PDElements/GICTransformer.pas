    ...
    begin
        ...
        begin
            ...
            case ParamPointer of
                ...
                9:
                    FkV1 := Parser[ActorID].DblValue;
                10:
                    FkV2 := Parser[ActorID].DblValue;
                11:
                    FMVArating := Parser[ActorID].DblValue;
                12:
                    FVarCurve := Param;
                13:
                    FpctR1 := Parser[ActorID].DblValue;
                14:
                    FpctR2 := Parser[ActorID].DblValue;
                15:
                    FKFactor := Parser[ActorID].DblValue;
            else
           // Inherited
