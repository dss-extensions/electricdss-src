...
begin
   ...
   {Assign default file name if alternate not specified}
    ...
    case ParamPointer of
        ...
        20:
            ExportCDPSM(Filename, Combined);    // defaults to a load-flow model
        21:
            ExportCDPSM(Filename, Functional);
        22:
            ExportCDPSM(Filename, Asset);
        23:
        ...
        28:
            ExportCDPSM(Filename, ElectricalProperties);
        29:
            ExportCDPSM(Filename, Geographical);
        30:
            ExportCDPSM(Filename, Topology);
        31:
            ExportCDPSM(Filename, StateVariables);
        32:
